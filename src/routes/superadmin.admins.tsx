    ...
    <div>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {pageItems.map((a) => {
                  ...
                  return (
                    <tr key={a.id} className="border-t border-[#28396C]/10">
                      <td className="px-5 py-3">
                        <div className="flex items-center gap-2.5">
                          <span className="grid h-8 w-8 shrink-0 place-items-center rounded-full bg-[#28396C] text-[11px] font-semibold text-[#B5E18B]">
                        ...
                        <div className="flex items-center justify-end gap-2">
                          ...
                          {!isSuper && !isSelf ? (
                            <button
                              ...
                              className={`${iconButton} hover:text-[#9A2F2F]`}
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className={dialogSurface}>
          <div className="border-b border-[#28396C]/10 px-6 py-5">
          ...
          <div className="flex items-center justify-end gap-2 border-t border-[#28396C]/10 px-6 py-4">
      ...
      >
        <AlertDialogContent className="rounded-3xl border-[#28396C]/10">
          <AlertDialogHeader>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              className="rounded-full bg-[#28396C] hover:bg-[#1B2A55]"
              onClick={() => {
