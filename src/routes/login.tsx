  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      <div className="relative hidden overflow-hidden bg-secondary p-12 text-foreground lg:flex lg:flex-col lg:justify-between">
        <div
          className="pointer-events-none absolute -right-[10%] -top-[15%] h-[55vw] w-[55vw] rounded-full bg-[color-mix(in_oklab,var(--eiden-gold)_12%,transparent)]"
          aria-hidden
        />
        <div
          className="pointer-events-none absolute -bottom-[20%] -left-[8%] h-[40vw] w-[40vw] rounded-full bg-[color-mix(in_oklab,var(--primary)_5%,transparent)]"
          aria-hidden
        />
        ...
        <div className="relative">
          ...
          <div className="mt-6 flex flex-wrap gap-2">
            {["Item 1", "Item 2", "Item 3", "Item 4", "Item 5"].map((t) => (
              <span
                key={t}
                className="border border-border bg-card px-3 py-1 text-xs text-foreground/85"
              >
                {t}
              </span>
            ))}
        ...
        <div
          className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-[var(--eiden-forest)] via-primary to-[var(--eiden-gold)]"
          aria-hidden
        />
      </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  type="button"
                  onClick={() => setShow((v) => !v)}
                  className="absolute right-0 top-1/2 -translate-y-1/2 text-muted-foreground transition hover:text-foreground"
                >
