...
export const sendMessage = createServerFn({ method: "POST" })
  .inputValidator((d: { sessionId: string; senderId: string; senderRole: "admin" | "superadmin"; content: string }) => d)
  .handler(async ({ data }) => {
...
export const createSession = createServerFn({ method: "POST" })
  .inputValidator((d: { adminId: string; adminName: string; centerId?: string | null }) => d)
  .handler(async ({ data }) => {
