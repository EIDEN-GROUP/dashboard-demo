    ...
    >
      <div
        className={cn(
          ...
          isMine
            ? "rounded-br-sm bg-[#28396C] text-white"
    ...
    <div className="relative">
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            <div className="flex items-center justify-between border-b border-border bg-[#28396C] px-4 py-3 text-white">
              ...
              {view === "list" ? (
                ...
                >
                  ...
                  {sessions.map((s, i) => (
                    ...
                    >
                      <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#28396C]/10 text-sm font-bold text-[#28396C]">
                  ...
                  {selectedSession?.status !== "closed" && (
                    ...
                    >
                      <textarea
                        ...
                        className="max-h-20 min-h-[36px] flex-1 resize-none rounded-xl border border-border bg-background px-3 py-2 text-sm outline-none focus:border-[#28396C] focus:ring-1 focus:ring-[#28396C]"
                      />
                      <motion.button
                        type="button"
                        onClick={sendMessage}
                        ...
                        className="grid h-9 w-9 shrink-0 place-items-center rounded-full bg-[#28396C] text-white transition hover:bg-[#28396C]/90 disabled:opacity-50"
                      >
